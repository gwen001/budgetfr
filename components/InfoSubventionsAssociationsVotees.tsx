...
export default function InfoSubventionsAssociationsVotees({ open, onClose }: Props) {
    if (!open) return null;
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-lg md:text-xl font-semibold mb-4 text-gray-900">Subventions aux associations votées par la ville de Paris.</h2>
                <p className="mb-6">
